...
$lang['cronDescription'] = 'This allows to create cron-based jobs. They will be executed accoring to the server setting (you need command line access to the cron tool).';
